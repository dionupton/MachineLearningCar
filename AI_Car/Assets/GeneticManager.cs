...
public class GeneticManager : MonoBehaviour
{
    ...
    public GameObject nNetworkHolders;
    ...
    private GameObject[] nNetPopulationHolders;
    ...
    private void CreatePopulation()
    {
        ...
        nNetPopulationHolders = new GameObject[initialPopulation];
    ...
    private void FillPopulationWithRandomValues(NNet[] newPopulation, int startingIndex)
    {
        ...
        {
            nNetPopulationHolders[startingIndex] = new GameObject();
            
            
            nNetPopulationHolders[startingIndex].AddComponent<NNet>();
            nNetPopulationHolders[startingIndex].GetComponent<NNet>().Initialise(controller.LAYERS, controller.NEURONS);
            newPopulation[startingIndex] = nNetPopulationHolders[startingIndex].GetComponent<NNet>();
            newPopulation[startingIndex].id = startingIndex;
    ...
    private void CrossOver(NNet[] newPopulation)
    {
        for(int i = 0; i < numberToCrossover; i+= 2)
        {
            ...
            GameObject Child1NNH = new GameObject();
            GameObject Child2NNH = new GameObject();

            Child1NNH.AddComponent<NNet>();
            Child2NNH.AddComponent<NNet>();

            NNet Child1 = Child1NNH.GetComponent<NNet>();
            NNet Child2 = Child2NNH.GetComponent<NNet>();
